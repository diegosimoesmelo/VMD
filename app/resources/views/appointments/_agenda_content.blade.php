    ...
    @if ($selectedVehicle)
        <div class="vehicle-hero">
            <div class="vehicle-hero-card">
                <span class="eyebrow">Veículo em foco</span>
                <h2>Você está montando a agenda deste veículo</h2>
                <div class="vehicle-plate">{{ strtoupper($selectedVehicle->placa) }}</div>
                <p>Todos os horários desta grade pertencem exclusivamente a este veículo. Qualquer aula marcada aqui reserva esta placa para o horário selecionado.</p>
            ...
            <div class="vehicle-hero-side">
                ...
                <div class="vehicle-focus-card">
                    ...
                    <p>Somente professores e alunos compatíveis com esta categoria entram no fluxo principal.</p>
                </div>
            </div>
        </div>
        ...
        <div class="agenda-week-nav">
            ...
            <a class="btn-secondary" data-agenda-nav href="{{ route('appointments.index', ['vehicle' => $selectedVehicle->id, 'vehicle_category' => $vehicleCategoryFilter, 'week_start' => $weekStart->copy()->addWeek()->toDateString()]) }}">Próxima semana</a>
        </div>
